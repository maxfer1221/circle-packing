...
pub fn detect_features_clean(
    ...
    th: u8,
    step: usize,
) -> std::io::Result<(Vec<Vec<[usize; 2]>>, isize)> {
...
fn get_feature_value(pa: &[Vec<i16>], x: usize, y: usize, t: i16) -> u8 {
...
pub fn linearize(fm: Vec<Vec<AtomicU8>>) -> (Vec<Vec<[usize; 2]>>, isize) {
